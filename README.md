...
│   └── font_editor_server.py  # שרת Flask לעורך הפונטים (פורט 5001)
├── frontend/
...
## ✏️ עורך פונטים (Font Editor)

כלי נפרד לעריכה ויזואלית של קבצי TTF — עריכת נקודות, קונטורים, ותצוגה מקדימה חיה.
...
נפתח בדפדפן בכתובת `http://127.0.0.1:5001`.
...
#### ממשק דו-שפתי
- **עברית / אנגלית** — מתג שפה עם דגלי 🇮🇱 🇺🇸 בפינת הממשק
- **נשמר בדפדפן** — הבחירה נזכרת בין הפעלות (localStorage)
...
| Ctrl+A | בחר הכל |
| Ctrl+S | שמור |
| Delete | מחק נקודות נבחרות / איפוס גליף |
| חצים | הזז (10px, עם Shift=1px) |
| +/- | הגדל/הקטן |
